  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        numEmployees: 1,
        logoUrl: "http://c1.img",
        jobs : [{ title: "J1", salary: 1, equity: "0.1", company_handle: "c1", id: expect.any(Number)}, {title: "J2", salary: 2, equity: "0.2", company_handle: "c1", id: expect.any(Number)}, {title: "J3", salary: 3, equity: null, company_handle: "c1", id: expect.any(Number)}]
      },
    });
  });
  ...
  test("works for anon: company w/o jobs", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c2.img",
        jobs: []
        // jobs : [{ title: "testJobTitle2", salary: 0, equity: "0.5", id: expect.any(Number),company_handle: "c2" }]
      },
    });
  });
